...
# Run the application
CMD ["sh", "-c", "echo 'Starting container...' && PYTHONUNBUFFERED=1 uvicorn youtube_cover_detector_api:app --host $HOST --port $PORT --workers 2 --log-level debug --access-log --use-colors"]
EXPOSE 8080